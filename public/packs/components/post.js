...
/* 36 */
/*!*************************************************!*\
  !*** ./app/javascript/packs/components/post.js ***!
  \*************************************************/
...
var Posts = function (_React$Component) {
  ...
  _createClass(Posts, [{
    ...
    value: function _handleKeyPress(e) {
      if (e.key === 'Enter') {
        var url = prefixURL + 'comments/create';
        var params = {};
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('div', { className: 'container' }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('div', { className: 'page' }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('div', { className: 'row' }, this.state.posts.map(function (post) {
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('div', { key: post.id, className: 'post' }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('div', { className: 'username' }, post.first_name + " " + post.last_name), __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('div', { className: 'caption' }, post.caption), __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('div', { className: 'image' }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('img', { src: domain + post.image, alt: '' })), __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('hr', null), __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('div', { className: 'form-group' }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('form', { action: 'api/v1/comments/create', method: 'post' }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('input', { type: 'text', className: 'form-control', placeholder: 'Write a comment...', name: 'comment[message]', onKeyPress: _this3._handleKeyPress }), __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('input', { type: 'hidden', name: 'comment[post_id]', value: post.id })), __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('div', { className: 'comments' }, post.comments.map(function (comment) {
